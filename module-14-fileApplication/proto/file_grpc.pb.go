...
type FileServiceClient interface {
	...
	DownloadFile(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*FileData, error)
	// Get metadata (unary)
	GetFileMetadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*MetadataResponse, error)
}
...
func (c *fileServiceClient) UploadFile(ctx context.Context, in *FileData, opts ...grpc.CallOption) (*UploadStatus, error) {
...
func (c *fileServiceClient) DownloadFile(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*FileData, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FileData)
...
func (c *fileServiceClient) GetFileMetadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*MetadataResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type FileServiceServer interface {
	...
	// Download a single file
	DownloadFile(context.Context, *DownloadRequest) (*FileData, error)
	// Get metadata (unary)
	GetFileMetadata(context.Context, *MetadataRequest) (*MetadataResponse, error)
...
func (UnimplementedFileServiceServer) UploadFile(context.Context, *FileData) (*UploadStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UploadFile not implemented")
}
func (UnimplementedFileServiceServer) DownloadFile(context.Context, *DownloadRequest) (*FileData, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DownloadFile not implemented")
}
func (UnimplementedFileServiceServer) GetFileMetadata(context.Context, *MetadataRequest) (*MetadataResponse, error) {
...
func _FileService_UploadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).UploadFile(ctx, req.(*FileData))
	}
...
func _FileService_GetFileMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).GetFileMetadata(ctx, req.(*MetadataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
