...
type ChatServiceClient interface {
	// Unary RPC for private messages
...
func (c *chatServiceClient) JoinChatRoom(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChatService_JoinChatRoomClient = grpc.ServerStreamingClient[ChatMessage]
...
func (UnimplementedChatServiceServer) JoinChatRoom(*JoinRequest, grpc.ServerStreamingServer[ChatMessage]) error {
...
func _ChatService_JoinChatRoom_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).JoinChatRoom(m, &grpc.GenericServerStream[JoinRequest, ChatMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChatService_JoinChatRoomServer = grpc.ServerStreamingServer[ChatMessage]
